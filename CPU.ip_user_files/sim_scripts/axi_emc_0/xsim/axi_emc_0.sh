...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L lib_pkg_v1_0_3 -L lib_srl_fifo_v1_0_3 -L emc_common_v3_0_6 -L axi_emc_v3_0_29 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_emc_0 xil_defaultlib.axi_emc_0 xil_defaultlib.glbl -log elaborate.log
}

# RUN_STEP: <simulate>
simulate()
{
  xsim axi_emc_0 -key {Behavioral:sim_1:Functional:axi_emc_0} -tclbatch cmd.tcl -log simulate.log
}
...
copy_setup_file()
{
  ...
  if [[ ($lib_map_path == "") ]]; then
    lib_map_path="H:/Xlinix/Vivado/2023.2/data/xsim"
  fi
...
reset_run()
{
  files_to_remove=(xelab.pb xsim.jou xvhdl.log xvlog.log compile.log elaborate.log simulate.log xelab.log xsim.log run.log xvhdl.pb xvlog.pb axi_emc_0.wdb xsim.dir libdpi.so)
