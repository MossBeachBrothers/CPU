...
design_libs=(xpm lib_pkg_v1_0_3 lib_srl_fifo_v1_0_3 emc_common_v3_0_6 axi_emc_v3_0_29 xil_defaultlib)
...
compile()
{
  ...
  vhdlan -work emc_common_v3_0_6 $vhdlan_opts \
  "../../../ipstatic/hdl/emc_common_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> vhdlan.log 2>/dev/null

  vhdlan -work axi_emc_v3_0_29 $vhdlan_opts \
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.axi_emc_0 xil_defaultlib.glbl -o axi_emc_0_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./axi_emc_0_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key axi_emc_0_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc axi_emc_0_simv.daidir vcs_lib c.obj)
