...
#
# Script generated by Vivado on Thu Sep 12 13:21:15 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : axi_emc_0.sh
...
#
# Usage        : axi_emc_0.sh
#                axi_emc_0.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                axi_emc_0.sh [-reset_run]
#                axi_emc_0.sh [-reset_log]
#                axi_emc_0.sh [-help]
#
...
#                script (type 'axi_emc_0.sh -help' for more information).
#
...
design_libs_elab="-libname xpm -libname lib_pkg_v1_0_3 -libname lib_srl_fifo_v1_0_3 -libname emc_common_v3_0_6 -libname axi_emc_v3_0_29 -libname xil_defaultlib -libname unisims_ver -libname unimacro_ver -libname secureip"

# set design libraries
design_libs=(simprims_ver xpm lib_pkg_v1_0_3 lib_srl_fifo_v1_0_3 emc_common_v3_0_6 axi_emc_v3_0_29 xil_defaultlib)

# simulation root library directory
sim_lib_dir="xcelium_lib"

# script info
echo -e "axi_emc_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./axi_emc_0.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
compile()
{
  ...
  xmvhdl -work emc_common_v3_0_6 $xmvhdl_opts \
  "../../../ipstatic/hdl/emc_common_v3_0_vh_rfs.vhd" \
  2>&1 | tee -a compile.log; cat .tmp_log >> xmvhdl.log 2>/dev/null

  xmvhdl -work axi_emc_v3_0_29 $xmvhdl_opts \
...
elaborate()
{
  xmelab $xmelab_opts $design_libs_elab xil_defaultlib.axi_emc_0 xil_defaultlib.glbl
}

# RUN_STEP: <simulate>
simulate()
{
  xmsim $xmsim_opts xil_defaultlib.axi_emc_0 -input simulate.do
}
...
reset_run()
{
  files_to_remove=(xmvlog.log xmvhdl.log xmsc.log compile.log elaborate.log simulate.log diag_report.log xsc_report.log axi_emc_0_sc.so .tmp_log xcelium_lib waves.shm c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./axi_emc_0.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: axi_emc_0.sh [-help]\n\
Usage: axi_emc_0.sh [-step]\n\
Usage: axi_emc_0.sh [-lib_map_path]\n\
Usage: axi_emc_0.sh [-reset_run]\n\
Usage: axi_emc_0.sh [-reset_log]\n\
Usage: axi_emc_0.sh [-keep_index]\n\
Usage: axi_emc_0.sh [-noclean_files]\n\n\
