...
#
# Script generated by Vivado on Thu Aug 29 16:03:45 -0700 2024
# SW Build 4029153 on Fri Oct 13 20:14:34 MDT 2023
#
# Copyright 1986-2022 Xilinx, Inc. All Rights Reserved.
# Copyright 2022-2023 Advanced Micro Devices, Inc. All Rights Reserved. 
#
# Filename     : clk_wiz_pll.sh
...
#
# Usage        : clk_wiz_pll.sh
#                clk_wiz_pll.sh [-lib_map_path] [-step] [-keep_index] [-noclean_files]*
#                clk_wiz_pll.sh [-reset_run]
#                clk_wiz_pll.sh [-reset_log]
#                clk_wiz_pll.sh [-help]
#
...
#                script (type 'clk_wiz_pll.sh -help' for more information).
#
...
# script info
echo -e "clk_wiz_pll.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
run()
{
  ...
  if [[ ($b_step == 1) ]]; then
    case $step in
      ...
      ;;
      * )
        echo -e "ERROR: Invalid or missing step '$step' (type \"./clk_wiz_pll.sh -help\" for more information)\n"
        exit 1
      esac
  else
    init_lib
...
elaborate()
{
  vcs $vcs_elab_opts xil_defaultlib.clk_wiz_pll xil_defaultlib.glbl -o clk_wiz_pll_simv
}

# RUN_STEP: <simulate>
simulate()
{
  ./clk_wiz_pll_simv $vcs_sim_opts -do simulate.do
}
...
reset_run()
{
  files_to_remove=(ucli.key clk_wiz_pll_simv vlogan.log vhdlan.log compile.log elaborate.log simulate.log .tmp_log .vlogansetup.env .vlogansetup.args .vcs_lib_lock scirocco_command.log lib_sc.so 64 AN.DB csrc clk_wiz_pll_simv.daidir vcs_lib c.obj)
...
check_arg_value()
{
  ...
  if [[ ($1 == "-lib_map_path") && ($2 == "") ]];then
    echo -e "ERROR: Simulation library directory path not specified (type \"./clk_wiz_pll.sh -help\" for more information)\n"
    exit 1
  fi
}
...
usage()
{
  msg="Usage: clk_wiz_pll.sh [-help]\n\
Usage: clk_wiz_pll.sh [-step]\n\
Usage: clk_wiz_pll.sh [-lib_map_path]\n\
Usage: clk_wiz_pll.sh [-reset_run]\n\
Usage: clk_wiz_pll.sh [-reset_log]\n\
Usage: clk_wiz_pll.sh [-keep_index]\n\
Usage: clk_wiz_pll.sh [-noclean_files]\n\n\
