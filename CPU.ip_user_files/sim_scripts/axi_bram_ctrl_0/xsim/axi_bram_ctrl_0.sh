...
#
# Script generated by Vivado on Wed Sep 11 19:43:46 -0700 2024
...
# script info
echo -e "axi_bram_ctrl_0.sh - Script generated by export_simulation (Vivado v2023.2 (64-bit)-id)\n"
...
elaborate()
{
  xelab --incr --debug typical --relax --mt 2  -L axi_bram_ctrl_v4_1_9 -L xil_defaultlib -L unisims_ver -L unimacro_ver -L secureip -L xpm --snapshot axi_bram_ctrl_0 xil_defaultlib.axi_bram_ctrl_0 xil_defaultlib.glbl -log elaborate.log
}
